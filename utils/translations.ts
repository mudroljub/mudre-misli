...
export const translations: Record<Language, Translations> = {
  stsl: {
    ...
    about: {
      intro: 'Ѹчилище Блатьнограда мьнима словѣньска школа мѫдролюбіꙗ девѧтаго вѣка · въ Блатьноградѣ бѣ · сѣдалищи паноньскꙑихъ Словѣнъ и єдиномь отъ прьвꙑихъ срѣдищь словѣньскаго писмени · Дѣло се показати тщить како бы мѫдролюбіє ѹчила сѧ · аще бы Словѣне велика ѹчилища въ срѣдьни вѣкъ имѣли · и како бы словѣньскъ ѹченъ ꙗꙁꙑкъ того врѣмене глаголалъ ·',

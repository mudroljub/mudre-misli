...
| ἀΐδιος            | вѣчьнъ                                | večan                           |
| αἰθήρ             | небєсьє                               | etar (nebesje)                  |
| αἴσθησις          | чѹвьство                              | čulo, čuvstvo                   |
| αἰτία             | вина *(alt: причина, начѧло)*         | uzrok                           |
| αἰών              | вѣкъ                                  | vek, eon                        |
| ἀλήθεια           | истина                                | istina                          |
| ἀνάγκη            | нѫжда                                 | nužda                           |
| ἀνεπιστημοσύνη    | невѣдѣніє                             | neznanje                        |
| ἀνεπιστήμων       | невѣдомъ                              | neupućen, neznalica             |
...
| γεννητός          | порожденъ                             | порођен                         |
| γεννήτωρ          | породитель                            | poroditelj                      |
...
| δύναμις           | сила                                  | moć, sila                       |
| εἰδέναι           | вѣдѣти                                | uvideti *(znati)*               |
| εἶδος             | видъ                                  | oblik, lik                      |
| εἴδωλον           | видѣніє, образъ                       | lik, slika                      |
| εἱμαρμένη         | сѫдьба                                | sudbina                         |
| εἶναι             | быти                                  | biti                            |
...
| ἐπίστασθαι        | наѹчити сѧ                            | naučiti se                      |
| ἐπιστήμη          | наѹка                                 | nauka                           |
...
| κοινός            | общь                                  | opšti                           |
| κόσμος            | строи, ѹкрасъ                         | stroj, ukras                    |
...
| οὐσία             | сѫщество *(alt: естество)*            | suština, supstancija            |

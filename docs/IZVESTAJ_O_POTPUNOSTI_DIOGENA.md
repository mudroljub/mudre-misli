# Izveštaj o potpunosti prema Diogenu Laertiju

Datum prve provere: 11. avgust 2026.

## Obuhvat

Provereni su postojeći pojedinačni fajlovi prema lokalnom grčkom tekstu u `data/sources/diogenes-laertius/el/`. Tales, Heraklit i Platon su preskočeni. Ovaj izveštaj dopunjuje `IZVESTAJ_O_DATIRANJU.md`.

Važno: oznaka ✅ u `data/sources/INDEX_LEARTIJE.md` trenutno znači samo da filozof ima ekstraktovan materijal. Ne znači da je njegovo poglavlje potpuno obrađeno.

Pri proceni su razlikovani:

- stvarno propušten citat, učenje ili anegdota;
- sadržaj koji već postoji preko Valtera Burlija, ali mu nedostaje veza sa odgovarajućim mestom kod Diogena;
- goli biografski podatak ili katalog dela, koji nije obavezno zaseban citat/anegdota;
- opšti prikaz škole koji Diogen ne pripisuje izričito samom filozofu.
...
Nedostaje ili nije povezano s Diogenom:

- poreklo, porodica i osnovna biografija iz I.89;
- Kleobulove izreke i saveti iz I.92, među njima načelo mere, odnos prema nepravdi, pobožnosti, vaspitanju, prijateljima i neprijateljima;
...
Treba proveriti i dopuniti:

- proročanstva o brodu, zemljotresu i osvajanju grada iz I.116–117;
- različita predanja o bolesti i smrti;
- odnos sa Pitagorom i Talesom;
...
Potvrđeno nedostaju lične epizode i podaci iz IX.63–67, između ostalog:

- Antigonovo suprotno svedočenje da Piron ipak nije živeo potpuno neoprezno;
- časti koje je dobio zbog Anaksarha i moguće veze sa Aleksandrom;
- svakodnevni poslovi, pomaganje sestri i prodavanje živine;
- bekstvo na drvo pred psom i odgovor na podsmeh zbog straha;
- lečenje rane bez pokazivanja bola;
...
Nedostaje ili je previše sažeto:

- promena imena i Aristotelov sud o njegovoj rečitosti;
- broj učenika i odnos prema javnom životu;
- progonstvo filozofa i brz povratak u Atinu;
...
Sledeći fajlovi zahtevaju punu proveru odeljka, jer raspored referenci pokazuje velike nepokrivene celine ili zato što poglavlje sadrži mnogo razgovornih epizoda:
...
- Svaki odeljak bez postojeće reference nije nužno propust: može sadržati samo spisak dela, genealogiju ili Diogenov komentar.
- Stavovi „stoika“, „skeptika“ ili „pitagorejaca“ nisu automatski stavovi Zenona, Pirona ili Pitagore.
- Različite verzije iste priče treba spojiti u jedan unos sa više izvora ili sa sačuvanim ogradama, a ne unositi kao duplikate.
- Burlijeva verzija i Diogenov grčki tekst često prenose istu priču. Tada treba dodati izvor postojećem unosu, ne praviti novi.

## Predloženi redosled potpune provere

1. Kleobul — kratak odeljak i očigledan propust.
2. Ferekid — kratak odeljak, ali mnogo preklapanja s Burlijem.
